    ...
    expect(
      AdminRevenueSummarySchema.safeParse({
        ...
        tierBreakdown: {
          ...
          freeGrossCents: 0,
          baseGrossCents: 1000,
          premiumGrossCents: 2000,
          ultraPremiumGrossCents: 1500,
          freePlatformFeeCents: 0,
          basePlatformFeeCents: 100,
          premiumPlatformFeeCents: 200,
          ultraPremiumPlatformFeeCents: 0,
          freeSellerNetCents: 0,
          baseSellerNetCents: 900,
          premiumSellerNetCents: 1800,
          ultraPremiumSellerNetCents: 1500,
        },
        topCreators: [
          {
            creatorId: 'c1',
